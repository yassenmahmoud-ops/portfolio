...
menuBtn === null || menuBtn === void 0 ? void 0 : menuBtn.addEventListener("click", () => {
    const isHidden = mobileMenu === null || mobileMenu === void 0 ? void 0 : mobileMenu.classList.toggle("hidden");
    if (!isHidden) {
        const items = mobileMenu === null || mobileMenu === void 0 ? void 0 : mobileMenu.querySelectorAll(".mobile-menu-item");
...
window.addEventListener("scroll", () => {
    if (window.pageYOffset > 300) {
        backToTop === null || backToTop === void 0 ? void 0 : backToTop.classList.add("show");
    }
    else {
        backToTop === null || backToTop === void 0 ? void 0 : backToTop.classList.remove("show");
    }
...
contactForm === null || contactForm === void 0 ? void 0 : contactForm.addEventListener("submit", (e) => {
    ...
    const subject = (subjectEl === null || subjectEl === void 0 ? void 0 : subjectEl.value.trim()) || "";
